...
// public class PaddleSubsystemOp extends SubsystemBase {
...
//     // Made new motors
//     // TalonFX leftPaddleMotor = new TalonFX(12);
//     // TalonFX rightPaddleMotor = new TalonFX(14);

//     // TODO #1: construct TalonFX as paddleMotor using the provided ID
//     // so the constructor stops erroring!
//     public PaddleSubsystemOP(int id) {
